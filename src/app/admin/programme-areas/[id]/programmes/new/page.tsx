...
interface NewProgrammePageProps {
  params: {
    id: string
  }
}

export default async function NewProgramme({ params }: NewProgrammePageProps) {
  await checkAuth()
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">New Programme</h1>
          <p className="text-muted-foreground">
            Create a new programme for {programmeArea.name}
          </p>
        </div>
      </div>
      ...
      <div className="text-center py-12">
        <p className="text-muted-foreground">
          Programme creation form coming soon...
        </p>
      </div>
    </div>
  )
