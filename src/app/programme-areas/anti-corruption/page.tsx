...
export default function AntiCorruptionPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch programmes and competitions for Anti-Corruption programme area
        const [programmesRes, competitionsRes] = await Promise.all([
          fetch('/api/programmes/by-category?category=anti-corruption'),
          fetch('/api/competitions/by-category?category=anti-corruption')
        ]);
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl">
              Our projects mobilise young people to speak out against corruption and advocate for
