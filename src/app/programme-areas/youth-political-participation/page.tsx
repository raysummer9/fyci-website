...
export default function YouthPoliticalParticipationPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch programmes and competitions for Youth Political Participation programme area
        const [programmesRes, competitionsRes] = await Promise.all([
          fetch('/api/programmes/by-category?category=youth-political-participation'),
          fetch('/api/competitions/by-category?category=youth-political-participation')
        ]);
  ...
  const allProjects = [
    ...programmes.map(programme => ({
      ...
      type: 'Programme',
      slug: programme.slug,
      image: programme.featured_image || '/img/anti-corruption.jpg'
    })),
    ...competitions.map(competition => ({
      ...
      image: competition.featured_image || '/img/anti-corruption.jpg'
    }))
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl">
              Our projects encourage meaningful youth participation in elections and other forms of
